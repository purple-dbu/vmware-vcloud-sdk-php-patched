<?php
class VMware_VCloud_API_OVF_EulaSection_Type extends VMware_VCloud_API_OVF_Section_Type {
    ...
    * @param VMware_VCloud_API_OVF_Msg_Type $License - [required]
    * @param array $Any - [optional] an array of any type of objects
    */
    public function __construct($required=null, $Info=null, $License=null, $Any=null) {
        parent::__construct($required, $Info);
        $this->License = $License;
        if (!is_null($Any)) {
            $this->Any = $Any;
        }
        $this->tagName = 'EulaSection';
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        if ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'License') {
