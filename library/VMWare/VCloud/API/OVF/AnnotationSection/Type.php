<?php
class VMware_VCloud_API_OVF_AnnotationSection_Type extends VMware_VCloud_API_OVF_Section_Type {
    ...
    * @param VMware_VCloud_API_OVF_Msg_Type $Annotation - [required]
    * @param array $Any - [optional] an array of any type of objects
    */
    public function __construct($required=null, $Info=null, $Annotation=null, $Any=null) {
        parent::__construct($required, $Info);
        $this->Annotation = $Annotation;
        if (!is_null($Any)) {
            $this->Any = $Any;
        }
        $this->tagName = 'AnnotationSection';
    ...
    protected function exportChildren($out, $level, $name, $namespace, $rootNS) {
        ...
        if (!is_null($this->Annotation)) {
            $out = $this->Annotation->export('Annotation', $out, $level, '', $namespace, $rootNS);
        }
        if (isset($this->Any)) {
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        if ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'Annotation') {
            $obj = new VMware_VCloud_API_OVF_Msg_Type();
            $obj->build($child);
            $obj->set_tagName('Annotation');
            $this->setAnnotation($obj);
            if (!empty($namespace)) {
