<?php
class VMware_VCloud_API_Extension_ResourceClassActionType extends VMware_VCloud_API_EntityType {
    protected $HttpMethod = null;
    protected $UrlPattern = null;
    protected $AclRules = null;
    ...
    * @param VMware_VCloud_API_Extension_AclRulesType $AclRules - [optional]
    */
    public function __construct($VCloudExtension=null, $href=null, $type=null, $Link=null, $operationKey=null, $id=null, $name=null, $Description=null, $Tasks=null, $HttpMethod=null, $UrlPattern=null, $AclRules=null) {
        parent::__construct($VCloudExtension, $href, $type, $Link, $operationKey, $id, $name, $Description, $Tasks);
        $this->HttpMethod = $HttpMethod;
        $this->UrlPattern = $UrlPattern;
        $this->AclRules = $AclRules;
        $this->tagName = 'ResourceClassAction';
    ...
    public function setAclRules($AclRules) { 
        $this->AclRules = $AclRules;
    }
    ...
    protected function exportChildren($out, $level, $name, $namespace, $rootNS) {
        ...
        if (!is_null($this->AclRules)) {
            $out = $this->AclRules->export('AclRules', $out, $level, '', $namespace, $rootNS);
        }
        return $out;
    }
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        if ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'HttpMethod') {
        ...
        elseif ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'UrlPattern') {
            $sval = $child->nodeValue;
        ...
        elseif ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'AclRules') {
            $obj = new VMware_VCloud_API_Extension_AclRulesType();
            $obj->build($child);
            $obj->set_tagName('AclRules');
            $this->setAclRules($obj);
            if (!empty($namespace)) {
                $this->namespace['AclRules'] = $namespace;
            }
        }
