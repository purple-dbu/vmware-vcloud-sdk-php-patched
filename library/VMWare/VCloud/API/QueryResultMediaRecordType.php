<?php
class VMware_VCloud_API_QueryResultMediaRecordType extends VMware_VCloud_API_QueryResultRecordType {
    protected $status = null;
    protected $storageProfileName = null;
    protected $name = null;
    protected $storageB = null;
    ...
    * @param long $storageB - [optional] an attribute, 
    ...
    */
    public function __construct($href=null, $type=null, $id=null, $Link=null, $Metadata=null, $status=null, $storageProfileName=null, $name=null, $storageB=null, $isPublished=null, $vdcName=null, $catalog=null, $vdc=null, $catalogItem=null, $ownerName=null, $isBusy=null, $owner=null, $org=null, $creationDate=null, $catalogName=null) {
    ...
    public function get_storageB(){
        return $this->storageB;
    }
    public function set_storageB($storageB) {
        $this->storageB = $storageB;
    }
    ...
    protected function exportAttributes($out, $level, $name, $namespace, $rootNS) {
        ...
        if (!is_null($this->storageB)) {
            $ns = VMware_VCloud_API_Helper::getAttributeNamespaceTag($this->namespace, 'storageB', self::$defaultNS, $namespace, $rootNS);
            $out = VMware_VCloud_API_Helper::addString($out, ' ' . $ns . 'storageB=' . VMware_VCloud_API_Helper::quote_attrib(VMware_VCloud_API_Helper::format_integer($this->storageB, $input_name='storageB')));
        }
    ...
    protected function buildAttributes($node, $namespaces='') {
        ...
        $ndstorageB = $attrs->getNamedItem('storageB');
        if (!is_null($ndstorageB)) {
            $this->storageB = sprintf('%d', $ndstorageB->value);
            if (isset($ndstorageB->prefix)) {
                $this->namespace['storageB'] = $ndstorageB->prefix;
                $nsUri = $ndstorageB->lookupNamespaceURI($ndstorageB->prefix);
            }
            $node->removeAttributeNS($nsUri, 'storageB');
        } else {
            $this->storageB = null;
        }
