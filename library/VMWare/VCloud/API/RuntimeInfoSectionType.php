<?php
class VMware_VCloud_API_RuntimeInfoSectionType extends VMware_VCloud_API_OVF_Section_Type {
    protected $VMWareTools = null;
    protected $Any = array();
    ...
    */
    ...
    protected function exportChildren($out, $level, $name, $namespace, $rootNS) {
        ...
        if (!is_null($this->VMWareTools)) {
            $out = $this->VMWareTools->export('VMWareTools', $out, $level, '', $namespace, $rootNS);
        }
        if (isset($this->Any)) {
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        if ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'VMWareTools') {
            $obj = new VMware_VCloud_API_VMWareTools();
            $obj->build($child);
            $obj->set_tagName('VMWareTools');
            $this->setVMWareTools($obj);
            if (!empty($namespace)) {
                $this->namespace['VMWareTools'] = $namespace;
            }
        }
