<?php
class VMware_VCloud_API_GatewayType extends VMware_VCloud_API_EntityType {
    ...
    * @param VMware_VCloud_API_GatewayConfigurationType $Configuration - [optional]
    */
    public function __construct($VCloudExtension=null, $href=null, $type=null, $Link=null, $operationKey=null, $id=null, $name=null, $Description=null, $Tasks=null, $status=null, $Configuration=null) {
        parent::__construct($VCloudExtension, $href, $type, $Link, $operationKey, $id, $name, $Description, $Tasks);
        $this->status = $status;
        $this->Configuration = $Configuration;
        $this->tagName = 'EdgeGateway';
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        if ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'Configuration') {
            $obj = new VMware_VCloud_API_GatewayConfigurationType();
            $obj->build($child);
