<?php
class VMware_VCloud_API_VmQuestionAnswerType {
    protected $ChoiceId = null;
   ...
   /**
    * @param int $ChoiceId - [required] 
    * @param string $QuestionId - [required] 
    */
    public function __construct($ChoiceId=null, $QuestionId=null) {
        $this->ChoiceId = $ChoiceId;
        $this->QuestionId = $QuestionId;
        $this->tagName = 'VmQuestionAnswer';
    ...
    protected function exportChildren($out, $level, $name, $namespace, $rootNS) {
        $namespace = self::$defaultNS;
        if (!is_null($this->ChoiceId)) {
            $out = VMware_VCloud_API_Helper::showIndent($out, $level);
            $ns = VMware_VCloud_API_Helper::getNamespaceTag($this->namespace, 'ChoiceId', self::$defaultNS, $namespace, $rootNS);
            $out = VMware_VCloud_API_Helper::addString($out, "<" . $ns . "ChoiceId>" . VMware_VCloud_API_Helper::format_integer($this->ChoiceId, $input_name='ChoiceId') . "</" . $ns . "ChoiceId>\n");
        }
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        if ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'ChoiceId') {
            $sval = $child->nodeValue;
            $this->ChoiceId = $sval;
            if (!empty($namespace)) {
                $this->namespace['ChoiceId'] = $namespace;
            }
        }
