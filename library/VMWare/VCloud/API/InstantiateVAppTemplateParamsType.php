<?php
class VMware_VCloud_API_InstantiateVAppTemplateParamsType extends VMware_VCloud_API_InstantiateVAppParamsType {
    ...
    */
    public function __construct($VCloudExtension=null, $name=null, $Description=null, $powerOn=null, $deploy=null, $VAppParent=null, $InstantiationParams=null, $linkedClone=null, $Source=null, $IsSourceDelete=null, $SourcedVmInstantiationParams=null, $AllEULAsAccepted=null) {
        parent::__construct($VCloudExtension, $name, $Description, $powerOn, $deploy, $VAppParent, $InstantiationParams, $linkedClone, $Source, $IsSourceDelete, $SourcedVmInstantiationParams);
        $this->AllEULAsAccepted = $AllEULAsAccepted;
        $this->tagName = 'InstantiateVAppTemplateParams';
