<?php
class VMware_VCloud_API_RasdItemsListType extends VMware_VCloud_API_ResourceType {
    ...
    */
    public function __construct($VCloudExtension=null, $href=null, $type=null, $Link=null, $Item=null) {
        parent::__construct($VCloudExtension, $href, $type, $Link);
        if (!is_null($Item)) {
            $this->Item = $Item;
        }
        $this->tagName = 'RasdItemsList';
