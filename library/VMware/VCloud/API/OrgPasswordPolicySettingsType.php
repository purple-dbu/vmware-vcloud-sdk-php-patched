<?php
class VMware_VCloud_API_OrgPasswordPolicySettingsType extends VMware_VCloud_API_ResourceType {
    ...
    * @param int $AccountLockoutIntervalMinutes - [required] 
    */
    public function __construct($VCloudExtension=null, $href=null, $type=null, $Link=null, $AccountLockoutEnabled=null, $InvalidLoginsBeforeLockout=null, $AccountLockoutIntervalMinutes=null) {
        ...
        $this->tagName = 'OrgPasswordPolicySettings';
    ...
    protected function exportChildren($out, $level, $name, $namespace, $rootNS) {
        ...
        if (!is_null($this->AccountLockoutIntervalMinutes)) {
            ...
            $out = VMware_VCloud_API_Helper::addString($out, "<" . $ns . "AccountLockoutIntervalMinutes>" . VMware_VCloud_API_Helper::format_integer($this->AccountLockoutIntervalMinutes, $input_name='AccountLockoutIntervalMinutes') . "</" . $ns . "AccountLockoutIntervalMinutes>\n");
        }
        return $out;
    }
