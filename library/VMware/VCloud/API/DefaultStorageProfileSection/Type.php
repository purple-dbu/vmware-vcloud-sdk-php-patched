<?php
class VMware_VCloud_API_DefaultStorageProfileSection_Type extends VMware_VCloud_API_OVF_Section_Type {
    ...
    * @param string $StorageProfile - [optional] 
    * @param array $Any - [optional] an array of any type of objects
    */
    public function __construct($required=null, $Info=null, $StorageProfile=null, $Any=null) {
        parent::__construct($required, $Info);
        $this->StorageProfile = $StorageProfile;
        if (!is_null($Any)) {
            $this->Any = $Any;
        }
        $this->tagName = 'DefaultStorageProfileSection';
    ...
    protected function exportChildren($out, $level, $name, $namespace, $rootNS) {
        ...
        if (!is_null($this->StorageProfile)) {
            ...
            $out = VMware_VCloud_API_Helper::addString($out, "<" . $ns . "StorageProfile>" . VMware_VCloud_API_Helper::quote_xml(VMware_VCloud_API_Helper::format_string(mb_convert_encoding($this->StorageProfile, VMware_VCloud_API_Helper::$ExternalEncoding, "auto"), $input_name='StorageProfile')) . "</" . $ns . "StorageProfile>\n");
        }
        if (isset($this->Any)) {
