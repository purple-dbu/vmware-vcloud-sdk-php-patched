<?php
class VMware_VCloud_API_TrustStoreUpdateParamsType extends VMware_VCloud_API_FileUploadParamsType {
    ...
    */
    public function __construct($VCloudExtension=null, $fileSize=null, $password=null) {
        parent::__construct($VCloudExtension, $fileSize);
        $this->password = $password;
        $this->tagName = 'TrustStoreUpdateParams';
