<?php
class VMware_VCloud_API_CoresPerSocket_Type extends VMware_VCloud_API_OVF_cimUnsignedInt {
    ...
    */
    public function __construct($required=null, $valueOf='') {
        parent::__construct($valueOf);
        $this->required = $required;
        $this->anyAttributes = array();
        $this->tagName = 'CoresPerSocket';
