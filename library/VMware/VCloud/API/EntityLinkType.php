<?php
class VMware_VCloud_API_EntityLinkType extends VMware_VCloud_API_EntityReferenceType {
    protected $rel = null;
    ...
    * @param string $rel - [required] an attribute, 
    */
    public function __construct($VCloudExtension=null, $type=null, $id=null, $name=null, $rel=null) {
        parent::__construct($VCloudExtension, $type, $id, $name);
        $this->rel = $rel;
        $this->tagName = 'EntityLink';
