<?php
class VMware_VCloud_API_QueryResultRoleRecordType extends VMware_VCloud_API_QueryResultRecordType {
    ...
    */
    public function __construct($href=null, $type=null, $id=null, $Link=null, $Metadata=null, $isReadOnly=null, $name=null) {
        parent::__construct($href, $type, $id, $Link, $Metadata);
        $this->isReadOnly = $isReadOnly;
        $this->name = $name;
        $this->tagName = 'RoleRecord';
