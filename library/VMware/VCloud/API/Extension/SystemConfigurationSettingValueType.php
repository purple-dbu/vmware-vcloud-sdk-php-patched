<?php
class VMware_VCloud_API_Extension_SystemConfigurationSettingValueType extends VMware_VCloud_API_VCloudExtensibleType {
    ...
    */
    public function __construct($VCloudExtension=null, $Value=null) {
        parent::__construct($VCloudExtension);
        $this->Value = $Value;
        $this->tagName = 'SystemConfigurationSettingValue';
