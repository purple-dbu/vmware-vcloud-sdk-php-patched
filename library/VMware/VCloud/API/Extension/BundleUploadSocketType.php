<?php
class VMware_VCloud_API_Extension_BundleUploadSocketType extends VMware_VCloud_API_VCloudExtensibleType {
    ...
    */
    public function __construct($VCloudExtension=null, $uploadLocation=null) {
        parent::__construct($VCloudExtension);
        $this->uploadLocation = $uploadLocation;
        $this->tagName = 'BundleUploadSocket';
