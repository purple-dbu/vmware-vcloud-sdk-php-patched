<?php
class VMware_VCloud_API_Extension_VmObjectRefType extends VMware_VCloud_API_Extension_VimObjectRefType {
    protected $name = null;
    ...
    */
    public function __construct($VimServerRef=null, $MoRef=null, $VimObjectType=null, $name=null) {
    ...
    public function export($name=null, $out='', $level=0, $namespacedef=null, $namespace=null, $rootNS=null) {
        ...
        if (NULL === $namespacedef) {
            ...
            if (0 >= strpos($namespacedef, 'xsi:type')) {
                $namespacedef = $namespacedef . " xsi:type='VmObjectRefType'";
            }
        }
