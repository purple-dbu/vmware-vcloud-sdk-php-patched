<?php
class VMware_VCloud_API_Extension_ServiceOfferingDisassociateParamsType extends VMware_VCloud_API_VCloudExtensibleType {
    ...
    */
    public function __construct($VCloudExtension=null, $ServiceOfferingRef=null) {
        parent::__construct($VCloudExtension);
        $this->ServiceOfferingRef = $ServiceOfferingRef;
        $this->tagName = 'ServiceOfferingDisassociateParams';
