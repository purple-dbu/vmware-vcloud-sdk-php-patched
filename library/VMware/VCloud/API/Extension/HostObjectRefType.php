<?php
class VMware_VCloud_API_Extension_HostObjectRefType extends VMware_VCloud_API_Extension_VimObjectRefType {
    ...
    */
    public function __construct($VimServerRef=null, $MoRef=null, $VimObjectType=null, $Username=null, $Password=null) {
        parent::__construct($VimServerRef, $MoRef, $VimObjectType);
    ...
    public function export($name=null, $out='', $level=0, $namespacedef=null, $namespace=null, $rootNS=null) {
        ...
        if (NULL === $namespacedef) {
            ...
            if (0 >= strpos($namespacedef, 'xsi:type')) {
                $namespacedef = $namespacedef . " xsi:type='HostObjectRefType'";
            }
        }
