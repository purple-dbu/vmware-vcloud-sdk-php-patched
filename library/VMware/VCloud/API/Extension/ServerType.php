<?php
class VMware_VCloud_API_Extension_ServerType extends VMware_VCloud_API_EntityType {
    ...
    */
    public function __construct($VCloudExtension=null, $href=null, $type=null, $Link=null, $operationKey=null, $id=null, $name=null, $Description=null, $Tasks=null, $Username=null, $Password=null, $Url=null) {
    ...
    public function export($name=null, $out='', $level=0, $namespacedef=null, $namespace=null, $rootNS=null) {
        ...
        if (NULL === $namespacedef) {
            ...
            if (0 >= strpos($namespacedef, 'xsi:type')) {
                $namespacedef = $namespacedef . " xsi:type='ServerType'";
            }
        }
