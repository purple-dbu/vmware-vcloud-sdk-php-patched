<?php
class VMware_VCloud_API_AllocatedIpAddressType extends VMware_VCloud_API_ResourceType {
    ...
    * @param string $allocationType - [required] an attribute, 
    * @param boolean $isDeployed - [optional] an attribute, 
    * @param string $IpAddress - [required] 
    */
    public function __construct($VCloudExtension=null, $href=null, $type=null, $Link=null, $allocationType=null, $isDeployed=null, $IpAddress=null) {
        parent::__construct($VCloudExtension, $href, $type, $Link);
        $this->allocationType = $allocationType;
        $this->isDeployed = $isDeployed;
        $this->IpAddress = $IpAddress;
        $this->tagName = 'IpAddress';
    ...
    public function get_allocationType(){
        return $this->allocationType;
    }
    public function set_allocationType($allocationType) {
        $this->allocationType = $allocationType;
    }
    ...
    protected function exportAttributes($out, $level, $name, $namespace, $rootNS) {
        ...
        $ns = VMware_VCloud_API_Helper::getAttributeNamespaceTag($this->namespace, 'allocationType', self::$defaultNS, $namespace, $rootNS);
        $out = VMware_VCloud_API_Helper::addString($out, ' ' . $ns . 'allocationType=' . VMware_VCloud_API_Helper::quote_attrib(VMware_VCloud_API_Helper::format_string(mb_convert_encoding($this->allocationType, VMware_VCloud_API_Helper::$ExternalEncoding, "auto"), $input_name='allocationType')));
    ...
    protected function buildAttributes($node, $namespaces='') {
        ...
        $ndallocationType = $attrs->getNamedItem('allocationType');
        if (!is_null($ndallocationType)) {
            $this->allocationType = $ndallocationType->value;
            if (isset($ndallocationType->prefix)) {
                $this->namespace['allocationType'] = $ndallocationType->prefix;
                $nsUri = $ndallocationType->lookupNamespaceURI($ndallocationType->prefix);
            }
            $node->removeAttributeNS($nsUri, 'allocationType');
        } else {
