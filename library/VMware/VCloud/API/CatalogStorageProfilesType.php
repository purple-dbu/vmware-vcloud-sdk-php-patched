<?php
class VMware_VCloud_API_CatalogStorageProfilesType extends VMware_VCloud_API_VCloudExtensibleType {
    ...
    * @param array $VdcStorageProfile - [optional] an array of VMware_VCloud_API_ReferenceType objects
    */
    public function __construct($VCloudExtension=null, $VdcStorageProfile=null) {
        parent::__construct($VCloudExtension);
        if (!is_null($VdcStorageProfile)) {
            $this->VdcStorageProfile = $VdcStorageProfile;
        }
        $this->tagName = 'CatalogStorageProfiles';
