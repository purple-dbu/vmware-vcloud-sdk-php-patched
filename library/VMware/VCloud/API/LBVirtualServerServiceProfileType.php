<?php
class VMware_VCloud_API_LBVirtualServerServiceProfileType extends VMware_VCloud_API_VCloudExtensibleType {
    ...
    * @param VMware_VCloud_API_LBPersistenceType $Persistence - [optional]
    */
    public function __construct($VCloudExtension=null, $IsEnabled=null, $Protocol=null, $Port=null, $Persistence=null) {
        parent::__construct($VCloudExtension);
        $this->IsEnabled = $IsEnabled;
        $this->Protocol = $Protocol;
        $this->Port = $Port;
        $this->Persistence = $Persistence;
        $this->tagName = 'ServiceProfile';
    ...
    protected function exportChildren($out, $level, $name, $namespace, $rootNS) {
        ...
        if (!is_null($this->Persistence)) {
            $out = $this->Persistence->export('Persistence', $out, $level, '', $namespace, $rootNS);
        }
        return $out;
    }
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        ...
        elseif ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'Persistence') {
            $obj = new VMware_VCloud_API_LBPersistenceType();
            $obj->build($child);
            $obj->set_tagName('Persistence');
            $this->setPersistence($obj);
            if (!empty($namespace)) {
                $this->namespace['Persistence'] = $namespace;
            }
        }
