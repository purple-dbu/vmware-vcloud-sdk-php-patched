<?php
class VMware_VCloud_API_VendorTemplateAttributesType extends VMware_VCloud_API_VCloudExtensibleType {
    protected $Name = null;
    protected $Key = null;
    ...
    */
    public function __construct($VCloudExtension=null, $Name=null, $Key=null, $Value=null) {
        parent::__construct($VCloudExtension);
        $this->Name = $Name;
        $this->Key = $Key;
        $this->Value = $Value;
        $this->tagName = 'VendorTemplateAttributes';
