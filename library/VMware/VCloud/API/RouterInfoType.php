<?php
class VMware_VCloud_API_RouterInfoType {
   ...
   /**
    * @param string $ExternalIp - [required] 
    */
    public function __construct($ExternalIp=null) {
        $this->ExternalIp = $ExternalIp;
        $this->tagName = 'RouterInfo';
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        if ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'ExternalIp') {
