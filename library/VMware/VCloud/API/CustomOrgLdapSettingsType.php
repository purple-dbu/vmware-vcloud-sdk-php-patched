...
class VMware_VCloud_API_CustomOrgLdapSettingsType extends VMware_VCloud_API_VCloudExtensibleType {
    ...
    * @param boolean $IsSsl - [optional] 
    * @param boolean $IsSslAcceptAll - [optional] 
    ...
    * @param VMware_VCloud_API_OrgLdapUserAttributesType $UserAttributes - [required]
    * @param VMware_VCloud_API_OrgLdapGroupAttributesType $GroupAttributes - [required]
    * @param boolean $UseExternalKerberos - [optional] 
    */
    public function __construct($VCloudExtension=null, $HostName=null, $Port=null, $IsSsl=null, $IsSslAcceptAll=null, $Realm=null, $SearchBase=null, $UserName=null, $Password=null, $AuthenticationMechanism=null, $GroupSearchBase=null, $IsGroupSearchBaseEnabled=null, $ConnectorType=null, $UserAttributes=null, $GroupAttributes=null, $UseExternalKerberos=null) {
        ...
        $this->tagName = 'CustomOrgLdapSettings';
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        ...
        elseif ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'UserAttributes') {
            $obj = new VMware_VCloud_API_OrgLdapUserAttributesType();
            $obj->build($child);
        ...
        elseif ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'GroupAttributes') {
            $obj = new VMware_VCloud_API_OrgLdapGroupAttributesType();
            $obj->build($child);
