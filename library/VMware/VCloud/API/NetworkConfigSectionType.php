<?php
class VMware_VCloud_API_NetworkConfigSectionType extends VMware_VCloud_API_OVF_Section_Type {
    protected $href = null;
    protected $type = null;
    protected $Link = array();
    protected $NetworkConfig = array();
    protected $Any = array();
    ...
    * @param array $NetworkConfig - [optional] an array of VMware_VCloud_API_VAppNetworkConfigurationType objects
    * @param array $Any - [optional] an array of any type of objects
    */
    public function __construct($required=null, $Info=null, $href=null, $type=null, $Link=null, $NetworkConfig=null, $Any=null) {
        ...
        $this->tagName = 'NetworkConfigSection';
    ...
    public function addNetworkConfig($value) { array_push($this->NetworkConfig, $value); }
    ...
    protected function exportChildren($out, $level, $name, $namespace, $rootNS) {
        ...
        if (isset($this->NetworkConfig)) {
            foreach ($this->NetworkConfig as $NetworkConfig) {
                $out = $NetworkConfig->export('NetworkConfig', $out, $level, '', $namespace, $rootNS);
            }
        }
        if (isset($this->Any)) {
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        ...
        elseif ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'NetworkConfig') {
            $obj = new VMware_VCloud_API_VAppNetworkConfigurationType();
            $obj->build($child);
            $obj->set_tagName('NetworkConfig');
            array_push($this->NetworkConfig, $obj);
            if (!empty($namespace)) {
                $this->namespace['NetworkConfig'] = $namespace;
            }
        }
