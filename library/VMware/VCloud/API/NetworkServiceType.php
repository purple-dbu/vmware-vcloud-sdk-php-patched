<?php
class VMware_VCloud_API_NetworkServiceType extends VMware_VCloud_API_VCloudExtensibleType {
    ...
    */
    public function __construct($VCloudExtension=null, $IsEnabled=null) {
        parent::__construct($VCloudExtension);
        $this->IsEnabled = $IsEnabled;
        $this->tagName = 'NetworkService';
