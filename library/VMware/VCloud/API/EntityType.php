<?php
class VMware_VCloud_API_EntityType extends VMware_VCloud_API_IdentifiableResourceType {
    protected $name = null;
    ...
    */
    ...
    protected function exportChildren($out, $level, $name, $namespace, $rootNS) {
        ...
        if (!is_null($this->Tasks)) {
            $out = $this->Tasks->export('Tasks', $out, $level, '', $namespace, $rootNS);
        }
        return $out;
    }
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        ...
        elseif ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'Tasks') {
            $obj = new VMware_VCloud_API_TasksInProgressType();
            $obj->build($child);
            $obj->set_tagName('Tasks');
            $this->setTasks($obj);
            if (!empty($namespace)) {
                $this->namespace['Tasks'] = $namespace;
            }
        }
