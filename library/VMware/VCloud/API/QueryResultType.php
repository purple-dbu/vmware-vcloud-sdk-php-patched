<?php
class VMware_VCloud_API_QueryResultType extends VMware_VCloud_API_ResourceType {
    protected $name = null;
    ...
    * @param integer $pageSize - [optional] an attribute, 
    * @param integer $page - [optional] an attribute, 
    */
    public function __construct($VCloudExtension=null, $href=null, $type=null, $Link=null, $name=null, $pageSize=null, $page=null) {
