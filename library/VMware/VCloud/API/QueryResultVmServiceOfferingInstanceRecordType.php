<?php
class VMware_VCloud_API_QueryResultVmServiceOfferingInstanceRecordType extends VMware_VCloud_API_QueryResultRecordType {
    ...
    * @param string $vmId - [optional] an attribute, 
    ...
    * @param string $vmEntityType - [optional] an attribute, 
    ...
    */
    public function __construct($href=null, $type=null, $id=null, $Link=null, $Metadata=null, $extensionId=null, $name=null, $vmId=null, $serviceOfferingName=null, $state=null, $ownerName=null, $extensionName=null, $isBusy=null, $vmEntityType=null, $vdcId=null, $serviceOfferingId=null, $description=null) {
        ...
        $this->tagName = 'VmServiceOfferingInstanceRecord';
    ...
    public function get_vmId(){
        return $this->vmId;
    }
    public function set_vmId($vmId) {
        $this->vmId = $vmId;
    }
    ...
    public function get_vmEntityType(){
        return $this->vmEntityType;
    }
    public function set_vmEntityType($vmEntityType) {
        $this->vmEntityType = $vmEntityType;
    }
    ...
    protected function exportAttributes($out, $level, $name, $namespace, $rootNS) {
        ...
        if (!is_null($this->vmId)) {
            $ns = VMware_VCloud_API_Helper::getAttributeNamespaceTag($this->namespace, 'vmId', self::$defaultNS, $namespace, $rootNS);
            $out = VMware_VCloud_API_Helper::addString($out, ' ' . $ns . 'vmId=' . VMware_VCloud_API_Helper::quote_attrib(VMware_VCloud_API_Helper::format_string(mb_convert_encoding($this->vmId, VMware_VCloud_API_Helper::$ExternalEncoding, "auto"), $input_name='vmId')));
        }
        ...
        if (!is_null($this->vmEntityType)) {
            $ns = VMware_VCloud_API_Helper::getAttributeNamespaceTag($this->namespace, 'vmEntityType', self::$defaultNS, $namespace, $rootNS);
            $out = VMware_VCloud_API_Helper::addString($out, ' ' . $ns . 'vmEntityType=' . VMware_VCloud_API_Helper::quote_attrib(VMware_VCloud_API_Helper::format_string(mb_convert_encoding($this->vmEntityType, VMware_VCloud_API_Helper::$ExternalEncoding, "auto"), $input_name='vmEntityType')));
        }
    ...
    protected function buildAttributes($node, $namespaces='') {
        ...
        $ndvmId = $attrs->getNamedItem('vmId');
        if (!is_null($ndvmId)) {
            $this->vmId = $ndvmId->value;
            if (isset($ndvmId->prefix)) {
                $this->namespace['vmId'] = $ndvmId->prefix;
                $nsUri = $ndvmId->lookupNamespaceURI($ndvmId->prefix);
            }
            $node->removeAttributeNS($nsUri, 'vmId');
        } else {
            $this->vmId = null;
        }
        ...
        $ndvmEntityType = $attrs->getNamedItem('vmEntityType');
        if (!is_null($ndvmEntityType)) {
            $this->vmEntityType = $ndvmEntityType->value;
            if (isset($ndvmEntityType->prefix)) {
                $this->namespace['vmEntityType'] = $ndvmEntityType->prefix;
                $nsUri = $ndvmEntityType->lookupNamespaceURI($ndvmEntityType->prefix);
            }
            $node->removeAttributeNS($nsUri, 'vmEntityType');
        } else {
            $this->vmEntityType = null;
        }
