<?php
class VMware_VCloud_API_ExtraConfig_Type extends VMware_VCloud_API_ConfigKeyValue_Type {
    ...
    */
    public function __construct($required=null, $value=null, $key=null, $valueOf='') {
        parent::__construct($required, $value, $key, $valueOf);
        $this->tagName = 'ExtraConfig';
