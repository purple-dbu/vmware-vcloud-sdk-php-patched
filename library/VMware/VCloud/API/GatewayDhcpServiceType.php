<?php
class VMware_VCloud_API_GatewayDhcpServiceType extends VMware_VCloud_API_NetworkServiceType {
    ...
    * @param array $Pool - [optional] an array of VMware_VCloud_API_DhcpPoolServiceType objects
    */
    public function __construct($VCloudExtension=null, $IsEnabled=null, $Pool=null) {
        parent::__construct($VCloudExtension, $IsEnabled);
        if (!is_null($Pool)) {
            $this->Pool = $Pool;
        }
        $this->tagName = 'GatewayDhcpService';
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        if ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'Pool') {
            $obj = new VMware_VCloud_API_DhcpPoolServiceType();
            $obj->build($child);
