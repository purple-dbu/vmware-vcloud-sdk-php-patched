<?php
class VMware_VCloud_API_QueryResultDatastoreProviderVdcRelationRecordType extends VMware_VCloud_API_QueryResultRecordType {
    protected $vc = null;
    ...
    * @param float $storageUsedMB - [optional] an attribute, 
    * @param string $name - [optional] an attribute, 
    * @param string $providerVdc - [optional] an attribute, 
    * @param boolean $isEnabled - [optional] an attribute, 
    * @param float $requestedStorageMB - [optional] an attribute, 
    * @param float $storageMB - [optional] an attribute, 
    ...
    * @param float $provisionedStorageMB - [optional] an attribute, 
    * @param string $datastore - [optional] an attribute, 
    * @param boolean $isDeleted - [optional] an attribute, 
    */
    public function __construct($href=null, $type=null, $id=null, $Link=null, $Metadata=null, $vc=null, $storageUsedMB=null, $name=null, $providerVdc=null, $isEnabled=null, $requestedStorageMB=null, $storageMB=null, $moref=null, $vcName=null, $datastoreType=null, $provisionedStorageMB=null, $datastore=null, $isDeleted=null) {
        ...
        $this->tagName = 'DatastoreProviderVdcRelationRecord';
    ...
    protected function exportAttributes($out, $level, $name, $namespace, $rootNS) {
        ...
        if (!is_null($this->storageUsedMB)) {
            ...
            $out = VMware_VCloud_API_Helper::addString($out, ' ' . $ns . 'storageUsedMB=' . VMware_VCloud_API_Helper::quote_attrib(VMware_VCloud_API_Helper::format_float($this->storageUsedMB, $input_name='storageUsedMB')));
        }
        ...
        if (!is_null($this->requestedStorageMB)) {
            ...
            $out = VMware_VCloud_API_Helper::addString($out, ' ' . $ns . 'requestedStorageMB=' . VMware_VCloud_API_Helper::quote_attrib(VMware_VCloud_API_Helper::format_float($this->requestedStorageMB, $input_name='requestedStorageMB')));
        }
        if (!is_null($this->storageMB)) {
            ...
            $out = VMware_VCloud_API_Helper::addString($out, ' ' . $ns . 'storageMB=' . VMware_VCloud_API_Helper::quote_attrib(VMware_VCloud_API_Helper::format_float($this->storageMB, $input_name='storageMB')));
        }
        ...
        if (!is_null($this->provisionedStorageMB)) {
            ...
            $out = VMware_VCloud_API_Helper::addString($out, ' ' . $ns . 'provisionedStorageMB=' . VMware_VCloud_API_Helper::quote_attrib(VMware_VCloud_API_Helper::format_float($this->provisionedStorageMB, $input_name='provisionedStorageMB')));
        }
    ...
    protected function buildAttributes($node, $namespaces='') {
        ...
        if (!is_null($ndstorageUsedMB)) {
            $this->storageUsedMB = sprintf('%f', $ndstorageUsedMB->value);
        ...
        if (!is_null($ndrequestedStorageMB)) {
            $this->requestedStorageMB = sprintf('%f', $ndrequestedStorageMB->value);
        ...
        if (!is_null($ndstorageMB)) {
            $this->storageMB = sprintf('%f', $ndstorageMB->value);
        ...
        if (!is_null($ndprovisionedStorageMB)) {
            $this->provisionedStorageMB = sprintf('%f', $ndprovisionedStorageMB->value);
