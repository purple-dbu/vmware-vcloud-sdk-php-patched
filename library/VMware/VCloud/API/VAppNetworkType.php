<?php
class VMware_VCloud_API_VAppNetworkType extends VMware_VCloud_API_NetworkType {
    ...
    */
    public function __construct($VCloudExtension=null, $href=null, $type=null, $Link=null, $operationKey=null, $id=null, $name=null, $Description=null, $Tasks=null, $Configuration=null, $deployed=null) {
        parent::__construct($VCloudExtension, $href, $type, $Link, $operationKey, $id, $name, $Description, $Tasks, $Configuration);
        $this->deployed = $deployed;
        $this->tagName = 'VAppNetwork';
