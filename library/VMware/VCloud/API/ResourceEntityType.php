<?php
class VMware_VCloud_API_ResourceEntityType extends VMware_VCloud_API_EntityType {
    ...
    */
    public function __construct($VCloudExtension=null, $href=null, $type=null, $Link=null, $operationKey=null, $id=null, $name=null, $Description=null, $Tasks=null, $status=null, $Files=null) {
    ...
    protected function exportChildren($out, $level, $name, $namespace, $rootNS) {
        ...
        if (!is_null($this->Files)) {
            $out = $this->Files->export('Files', $out, $level, '', $namespace, $rootNS);
        }
        return $out;
    }
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        if ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'Files') {
            $obj = new VMware_VCloud_API_FilesListType();
            $obj->build($child);
            $obj->set_tagName('Files');
            $this->setFiles($obj);
            if (!empty($namespace)) {
                $this->namespace['Files'] = $namespace;
            }
        }
