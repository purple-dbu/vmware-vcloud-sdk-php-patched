<?php
class VMware_VCloud_API_RecomposeVAppParamsType extends VMware_VCloud_API_ComposeVAppParamsType {
    protected $CreateItem = array();
    ...
    * @param array $CreateItem - [optional] an array of VMware_VCloud_API_VmType objects
    * @param array $DeleteItem - [optional] an array of VMware_VCloud_API_ReferenceType objects
    */
    public function __construct($VCloudExtension=null, $name=null, $Description=null, $powerOn=null, $deploy=null, $VAppParent=null, $InstantiationParams=null, $linkedClone=null, $SourcedItem=null, $AllEULAsAccepted=null, $CreateItem=null, $DeleteItem=null) {
        parent::__construct($VCloudExtension, $name, $Description, $powerOn, $deploy, $VAppParent, $InstantiationParams, $linkedClone, $SourcedItem, $AllEULAsAccepted);
        if (!is_null($CreateItem)) {
            $this->CreateItem = $CreateItem;
        }
        if (!is_null($DeleteItem)) {
            $this->DeleteItem = $DeleteItem;
        }
        $this->tagName = 'RecomposeVAppParams';
    ...
    public function setCreateItem($CreateItem) { 
        $this->CreateItem = $CreateItem;
    }
    public function addCreateItem($value) { array_push($this->CreateItem, $value); }
    ...
    protected function exportChildren($out, $level, $name, $namespace, $rootNS) {
        ...
        if (isset($this->CreateItem)) {
            foreach ($this->CreateItem as $CreateItem) {
                $out = $CreateItem->export('CreateItem', $out, $level, '', $namespace, $rootNS);
            }
        }
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        if ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'CreateItem') {
            $obj = new VMware_VCloud_API_VmType();
            $obj->build($child);
            $obj->set_tagName('CreateItem');
            array_push($this->CreateItem, $obj);
            if (!empty($namespace)) {
                $this->namespace['CreateItem'] = $namespace;
            }
        }
