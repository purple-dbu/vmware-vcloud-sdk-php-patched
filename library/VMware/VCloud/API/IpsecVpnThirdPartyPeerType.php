<?php
class VMware_VCloud_API_IpsecVpnThirdPartyPeerType extends VMware_VCloud_API_IpsecVpnUnmanagedPeerType {
    ...
    */
    public function __construct($VCloudExtension=null, $PeerId=null) {
        parent::__construct($VCloudExtension);
        $this->PeerId = $PeerId;
        $this->tagName = 'IpsecVpnThirdPartyPeer';
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        if ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'PeerId') {
