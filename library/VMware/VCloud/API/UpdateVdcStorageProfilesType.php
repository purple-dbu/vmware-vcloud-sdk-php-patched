<?php
class VMware_VCloud_API_UpdateVdcStorageProfilesType extends VMware_VCloud_API_ParamsType {
    ...
    * @param array $AddStorageProfile - [optional] an array of VMware_VCloud_API_VdcStorageProfileParamsType objects
    ...
    */
    public function __construct($VCloudExtension=null, $name=null, $Description=null, $AddStorageProfile=null, $RemoveStorageProfile=null) {
        ...
        $this->tagName = 'UpdateVdcStorageProfiles';
    ...
    protected function exportChildren($out, $level, $name, $namespace, $rootNS) {
        ...
        if (isset($this->AddStorageProfile)) {
            foreach ($this->AddStorageProfile as $AddStorageProfile) {
                $out = $AddStorageProfile->export('AddStorageProfile', $out, $level, '', $namespace, $rootNS);
            }
        }
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        if ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'AddStorageProfile') {
            ...
            $obj->build($child);
            $obj->set_tagName('AddStorageProfile');
            array_push($this->AddStorageProfile, $obj);
            if (!empty($namespace)) {
