<?php
class VMware_VCloud_API_OVF_ResourceAllocationSection_Type extends VMware_VCloud_API_OVF_Section_Type {
    ...
    */
    public function __construct($required=null, $Info=null, $Item=null, $Any=null) {
        ...
        $this->tagName = 'ResourceAllocationSection';
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        if ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'Item') {
