<?php
class VMware_VCloud_API_OVF_Content_Type {
    protected $id = null;
    protected $Info = null;
    protected $Name = null;
    ...
    */
    public function __construct($id=null, $Info=null, $Name=null, $Section=null) {
        $this->id = $id;
        $this->Info = $Info;
        $this->Name = $Name;
        if (!is_null($Section)) {
    ...
    protected function exportChildren($out, $level, $name, $namespace, $rootNS) {
        ...
        if (!is_null($this->Name)) {
            $out = $this->Name->export('Name', $out, $level, '', $namespace, $rootNS);
        }
