<?php
class VMware_VCloud_API_OVF_NetworkSection_Type extends VMware_VCloud_API_OVF_Section_Type {
    ...
    * @param array $Network - [optional] an array of VMware_VCloud_API_OVF_Network objects
    * @param array $Any - [optional] an array of any type of objects
    */
    public function __construct($required=null, $Info=null, $Network=null, $Any=null) {
    ...
    public function addNetwork($value) { array_push($this->Network, $value); }
    ...
    protected function exportChildren($out, $level, $name, $namespace, $rootNS) {
        ...
        if (isset($this->Network)) {
            foreach ($this->Network as $Network) {
                $out = $Network->export('Network', $out, $level, '', $namespace, $rootNS);
            }
        }
        if (isset($this->Any)) {
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        if ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'Network') {
            $obj = new VMware_VCloud_API_OVF_Network();
            $obj->build($child);
