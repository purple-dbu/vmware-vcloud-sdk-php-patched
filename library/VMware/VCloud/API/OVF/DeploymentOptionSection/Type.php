<?php
class VMware_VCloud_API_OVF_DeploymentOptionSection_Type extends VMware_VCloud_API_OVF_Section_Type {
    ...
    * @param array $Configuration - [required] an array of VMware_VCloud_API_OVF_Configuration objects
    * @param array $Any - [optional] an array of any type of objects
    */
    public function __construct($required=null, $Info=null, $Configuration=null, $Any=null) {
        ...
        $this->tagName = 'DeploymentOptionSection';
    ...
    public function addConfiguration($value) { array_push($this->Configuration, $value); }
    ...
    protected function exportChildren($out, $level, $name, $namespace, $rootNS) {
        ...
        if (isset($this->Configuration)) {
            foreach ($this->Configuration as $Configuration) {
                $out = $Configuration->export('Configuration', $out, $level, '', $namespace, $rootNS);
            }
        }
        if (isset($this->Any)) {
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        if ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'Configuration') {
            $obj = new VMware_VCloud_API_OVF_Configuration();
            $obj->build($child);
