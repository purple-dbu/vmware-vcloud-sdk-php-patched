<?php
class VMware_VCloud_API_OVF_References_Type {
   ...
   /**
    * @param array $File - [optional] an array of VMware_VCloud_API_OVF_File_Type objects
    * @param array $Any - [optional] an array of any type of objects
    */
    public function __construct($File=null, $Any=null) {
        if (!is_null($File)) {
            $this->File = $File;
        }
        if (!is_null($Any)) {
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        if ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'File') {
            $obj = new VMware_VCloud_API_OVF_File_Type();
            $obj->build($child);
