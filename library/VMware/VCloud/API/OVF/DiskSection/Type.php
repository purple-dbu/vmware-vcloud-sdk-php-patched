<?php
class VMware_VCloud_API_OVF_DiskSection_Type extends VMware_VCloud_API_OVF_Section_Type {
    ...
    * @param array $Disk - [optional] an array of VMware_VCloud_API_OVF_VirtualDiskDesc_Type objects
    * @param array $Any - [optional] an array of any type of objects
    */
    public function __construct($required=null, $Info=null, $Disk=null, $Any=null) {
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        if ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'Disk') {
            $obj = new VMware_VCloud_API_OVF_VirtualDiskDesc_Type();
            $obj->build($child);
