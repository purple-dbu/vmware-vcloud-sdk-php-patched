<?php
class VMware_VCloud_API_ComputeCapacityType extends VMware_VCloud_API_VCloudExtensibleType {
    protected $Cpu = null;
    ...
    * @param VMware_VCloud_API_CapacityWithUsageType $Cpu - [required]
    * @param VMware_VCloud_API_CapacityWithUsageType $Memory - [required]
    */
    public function __construct($VCloudExtension=null, $Cpu=null, $Memory=null) {
