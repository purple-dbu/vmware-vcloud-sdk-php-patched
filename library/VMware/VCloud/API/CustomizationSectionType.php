<?php
class VMware_VCloud_API_CustomizationSectionType extends VMware_VCloud_API_OVF_Section_Type {
    protected $href = null;
    protected $type = null;
    protected $goldMaster = null;
    protected $CustomizeOnInstantiate = null;
    ...
    * @param boolean $CustomizeOnInstantiate - [required] 
    * @param array $Link - [optional] an array of VMware_VCloud_API_LinkType objects
    * @param array $Any - [optional] an array of any type of objects
    */
    public function __construct($required=null, $Info=null, $href=null, $type=null, $goldMaster=False, $CustomizeOnInstantiate=null, $Link=null, $Any=null) {
    ...
    protected function exportChildren($out, $level, $name, $namespace, $rootNS) {
        ...
        if (!is_null($this->CustomizeOnInstantiate)) {
            $out = VMware_VCloud_API_Helper::showIndent($out, $level);
            $ns = VMware_VCloud_API_Helper::getNamespaceTag($this->namespace, 'CustomizeOnInstantiate', self::$defaultNS, $namespace, $rootNS);
            $out = VMware_VCloud_API_Helper::addString($out, "<" . $ns . "CustomizeOnInstantiate>" . VMware_VCloud_API_Helper::format_boolean($this->CustomizeOnInstantiate, $input_name='CustomizeOnInstantiate') . "</" . $ns . "CustomizeOnInstantiate>\n");
     }
        if (isset($this->Link)) {
    ...
    protected function hasContent() {
        if (
            !is_null($this->CustomizeOnInstantiate) ||
            !empty($this->Link) ||
            !empty($this->Any) ||
            parent::hasContent()
            ) {
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        if ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'CustomizeOnInstantiate') {
            $sval = VMware_VCloud_API_Helper::get_boolean($child->nodeValue);
            $this->CustomizeOnInstantiate = $sval;
            if (!empty($namespace)) {
                $this->namespace['CustomizeOnInstantiate'] = $namespace;
            }
        }
