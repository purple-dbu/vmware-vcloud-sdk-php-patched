...
class VMware_VCloud_API_OVFENV_PropertySection_Type extends VMware_VCloud_API_OVFENV_Section_Type {
   ...
   /**
    * @param array $Property - [optional] an array of VMware_VCloud_API_OVFENV_Property objects
    * @param array $Any - [optional] an array of any type of objects
    * @param string $valueOf - [optional]
    */
    public function __construct($Property=null, $Any=null, $valueOf='') {
    ...
    protected function buildChildren($child, $nodeName, $namespace='') {
        if ($child->nodeType == XML_ELEMENT_NODE && $nodeName == 'Property') {
            $obj = new VMware_VCloud_API_OVFENV_Property();
            $obj->build($child);
